...
// this code is generated by ChatGPT but after getting the code and making sure that it works,
// I researched for midpoint algorithm and read about it from these sources:
