...
void main()
{
...
#else
	window = glfwCreateWindow(SCRWIDTH, SCRHEIGHT + HUDHEIGHT, "Metal Gear 2D - by Hesam Ghadimi @BUAS", 0, 0);
#endif
	...
	printf(
		"BUAS Year1 BlockA Game Programming Project\n"
		"Made by Hesam Ghadimi\n"
		"Running Jacco Bikker's Template\n\n"
		...
		"Open/Close Radio	 K\n\n"
		"Radio Controls:\n"
		"Change Frequency	 Left/Right Arrow Keys\n"
		"Send/Recieve		 Up/Down Arrow Keys\n"
		"Skip Dialog		 Enter\n\n"

		"Objective:\n"
		"Reach the elevator to escape."
	);
